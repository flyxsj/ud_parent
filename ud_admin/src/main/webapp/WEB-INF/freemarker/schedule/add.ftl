...
<body class="menu-page" ng-controller="AddScheduleCtrl as vm">
<div id="main-box">
        ...
        <div class="container">
            <div class="row">
                <div class="col-xs-12 col-sm-8 col-md-push-2">
                    <h2 class="page-title">添加Schedule</h2>
                        ...
                        <div class="panel panel-default">
                            ...
                            <div class="panel-body">
                                ...
                                <div class="form-group">
                                    ...
                                    <div class="col-sm-10">
                                        <input type="text" class="form-control" ng-model="vm.entity.day">
                                    </div>
                                </div>
                                <div class="form-group">
                                ...
                                <div class="form-group">
                                    ...
                                    <div class="col-sm-10">
                                        <input type="text" class="form-control" ng-model="vm.entity.isAlwaysEnable">
                                    </div>
                                </div>
                                <div class="form-group">
