...
<body class="menu-page" ng-controller="EditRecruitCtrl as vm">
<div id="main-box">
        ...
        <div class="container">
            <div class="row">
                <div class="col-xs-12 col-sm-8 col-md-push-2">
                    <h2 class="page-title">编辑Recruit</h2>
                        ...
                        <div class="panel panel-default">
                            ...
                            <div class="panel-body">
                                ...
                                <div class="form-group">
                                    ...
                                    <div class="col-sm-10">
                                        <input type="text" class="form-control" value="${entity.schoolName!''}" ng-model="vm.entity.schoolName">
                                    </div>
                                </div>
                                <div class="form-group">
                                    ...
                                    <div class="col-sm-10">
                                        <input type="text" class="form-control" value="${entity.price!''}" ng-model="vm.entity.price">
                                    </div>
                                </div>
                                <div class="form-group">
                                    ...
                                    <div class="col-sm-10">
                                        <input type="text" class="form-control" value="${entity.scope!''}" ng-model="vm.entity.scope">
                                    </div>
                                </div>
                                <div class="form-group">
                                ...
                                <div class="form-group">
                                    ...
                                    <div class="col-sm-10">
                                        <input type="text" class="form-control" value="${entity.phone!''}" ng-model="vm.entity.phone">
                                    </div>
                                </div>
                                <div class="form-group">
                                    ...
                                    <div class="col-sm-10">
                                        <input type="text" class="form-control" value="${entity.introduce!''}" ng-model="vm.entity.introduce">
                                    </div>
                                </div>
                                <div class="form-group">
                                ...
                                <div class="form-group">
                                    ...
                                    <div class="col-sm-10">
                                        <input type="text" class="form-control" value="${entity.updateTime!''}" ng-model="vm.entity.updateTime">
                                    </div>
                                </div>
                                <div>
