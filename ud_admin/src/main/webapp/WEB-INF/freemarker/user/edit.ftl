...
<body class="menu-page" ng-controller="EditAdminUserCtrl as vm">
<div id="main-box">
                        ...
                        <div class="panel panel-default">
                            ...
                            <div class="panel-body">
                                <div class="form-group">
                                    ...
                                    <div class="col-sm-10">
                                        <input type="text" class="form-control" value="${user.username}"
                                               ng-model="vm.entity.username" required>
                                    </div>
                                </div>
                                <div class="form-group">
                                ...
                                <div class="form-group">
                                    ...
                                    <div class="col-sm-10">
                                        <input type="text" class="form-control" value="${user.roleType!''}" ng-model="vm.entity.roleType" required>
                                    </div>
                                </div>
                                <div class="form-group">
                                    ...
                                    <div class="col-sm-10">
                                        <input type="text" class="form-control" value="${user.remark!''}" ng-model="vm.entity.remark">
                                    </div>
                                </div>
                                <div>
